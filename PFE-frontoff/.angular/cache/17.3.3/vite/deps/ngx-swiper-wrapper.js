...
var SwiperDirective = class {
  constructor(platformId, zone, elementRef, differs, defaults2) {
...
SwiperDirective.ctorParameters = () => [
  ...
  { type: void 0, decorators: [{ type: Optional }, { type: Inject, args: [SWIPER_CONFIG] }] }
];
...
var SwiperComponent = class {
  constructor(zone, cdRef, platformId, defaults2) {
    this.zone = zone;
    this.cdRef = cdRef;
    this.platformId = platformId;
    this.defaults = defaults2;
